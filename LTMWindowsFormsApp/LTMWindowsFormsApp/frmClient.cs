    ...
    public partial class frmClient : Form
    {
        ...
        private void btnConnectAndWatch_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                MessageBox.Show("Đã kết nối Server, đang giám sát");
                btnConnectAndWatch.Enabled = false;
                StartWatching(path);
                this.Hide();
                notifyIcon1.Visible = true;
                notifyIcon1.ShowBalloonTip(3000, "Thông báo", "Ứng dụng đang chạy ngầm và đang giám sát thư mục.", ToolTipIcon.Info);
            }
            catch (Exception ex)
            {
